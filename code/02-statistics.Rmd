...
sum(is.na(data$p450)) # Checks for NA values in p450
sum(is.nan(data$p450)) # Checks for NaN values in p450
sum(is.infinite(data$p450)) # Checks for Inf values in p450

sum(is.na(data$SOD))
sum(is.nan(data$SOD)) 
sum(is.infinite(data$SOD)) 

sum(is.na(data$condition_factor)) 
sum(is.nan(data$condition_factor)) 
sum(is.infinite(data$condition_factor)) 
...
clean_data <- data[complete.cases(data[, c("p450", "SOD", "condition_factor")]), ]
