...
plmw<- read.csv("../data/phmw_grouping_for_averages.csv")
...
df <- df %>%
  left_join(pcb, by = "site_name")

# check
head(df)

write.csv(df, "/Users/cmantegna/Documents/GitHub/WDFWmussels/data/complete_with_nas.csv")
```
