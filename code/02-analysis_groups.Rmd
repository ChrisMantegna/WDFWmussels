---
title: "02- Analysis Groups: Creating the Grouping Metrics for Sample level and above analysis"
output:
  pdf_document: 
    fig_width: 20
    fig_height: 9
...
p16<- read.csv("../data/p16_group.csv")
p42<- read.csv("../data/p42_group.csv")
phmw<- read.csv("../data/phmw_group.csv")
plmw<- read.csv("../data/plmw_group.csv")
pcb<- read.csv("../data/pcb_group.csv")
# check it out
