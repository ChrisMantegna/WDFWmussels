...
data_clean_p450$site_name <- as.factor(data_clean_p450$site_name)
data_clean_sod$site_name <- as.factor(data_clean_sod$site_name)
data_clean_condition_factor$site_name <- as.factor(data_clean_condition_factor$site_name)
data_clean_avg_thickness$site_name <- as.factor(data_clean_avg_thickness$site_name)
# remove outliers
...
# outliers removed
# KW + Post Hoc
kruskal.test(p450 ~ reporting_area, data = data_clean_p450) # result: p< 6.616e-5

dunn <- dunnTest(data_clean_p450$p450, data_clean_p450$reporting_area, method = "bonferroni", list = TRUE)
mc <- data.frame(
