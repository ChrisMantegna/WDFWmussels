...
p16<- read.csv("../data/p16_grouping_for_averages.csv")
p42<- read.csv("../data/p42_grouping_for_averages.csv")
phmw<- read.csv("../data/phmw_grouping_for_averages.csv")
plmw<- read.csv("../data/cleaned/plmw_grouping_for_averages.csv")
pcb<- read.csv("../data/pcb_grouping_for_averages.csv")
# check it out
...
plmw$DryValue_Group <- cut(dry_values, breaks = breaks, labels = 1:num_classes, include.lowest = TRUE)
...
write.csv(plmw, "../data/plmw_grouping_for_averages.csv", row.names = FALSE)
...
write.csv(data, "../data/cleaned/updated_geo_group", row.names = FALSE)
...
write.csv(df, "/Users/cmantegna/Documents/GitHub/WDFWmussels/data/plmw_with_nas.csv")
```
