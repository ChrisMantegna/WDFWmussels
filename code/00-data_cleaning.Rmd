...
# load data
data<- read.csv("../data/raw_complete_with_groups.csv")
...
data$sod[data$sod <= 0] <- 0.00354

# check
summary(data)

write.csv(data, "/Users/cmantegna/Documents/GitHub/WDFWmussels/data/cleaned/complete_with_groups.csv")
...
## Variance, p= 5.744e-5, we can NOT use PERMANOVA for the stats, must use Kruskal-Wallis
...
# Check for Outliers - No Need. Outliers do not impact stats
...
summary(data[, paste0(metrics, "_outlier")]) # outliers: p450= , sod= , cf1= , cf2= , cf3= , shell=  
