...
morph<- read.csv("/Users/cmantegna/Documents/WDFWmussels/data/morphometricdata.csv")
...
#morphometric
merged_df <- merge(mdata, idata, by = "site_name", all = TRUE)

# Print the merged data frame
print(merged_df)
write.csv(merged_df, "/Users/cmantegna/Documents/WDFWmussels/data/morph_analytes.csv", row.names = FALSE)
...
#morphometric
merged_df <- merge(mdata, data, by = "site_name", all = TRUE)
