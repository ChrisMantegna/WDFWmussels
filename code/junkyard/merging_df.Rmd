...
#sod
merged_df3 <- merge(sdata, metal_wide, by = "site_name", all = TRUE)

# Print the merged data frame
head(merged_df3)
write.csv(merged_df3, "/Users/cmantegna/Documents/WDFWmussels/data/avgSOD_metals.csv", row.names = FALSE)
