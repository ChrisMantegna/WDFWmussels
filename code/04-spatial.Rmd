...
#### Exploratory data analysis tool that looks to interpret the distribution of my values across geographic space - I believe this is the first step in geospatial analysis, the Moran and Geary C statistical tests are what follow to support or debate the hypothesis formed from this step.
...
moran_result <- moran.test(sf_data$p450, weights)
print(moran_result)
