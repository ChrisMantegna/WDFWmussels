...
## fixing sod values - no need to run after 9.26.25
```{r }
...
morphometric_metrics <- c("shell", "length_mm", "height_mm", "width_mm", "weight_initial_g", "weight_change_g", "weight_final_g")
