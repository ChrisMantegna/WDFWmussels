...
chlordane<- read.csv("../data/test_chlordane.csv")
ddt<- read.csv("../data/test_ddt.csv")
hch<- read.csv("../data/test_hch.csv")
metal<- read.csv("../data/test_metal.csv")
pbde<- read.csv("../data/test_pbde.csv")
pcb<- read.csv("../data/test_pcb.csv")
pesticide<- read.csv("../data/test_pesticide.csv")
