...
# double check the df's - i updated once i built my new ones

df1<- read.csv("../data/all_with_imputations_and_identifiers.csv")
chlordane<- read.csv("../data/indices/chlordane_wide.csv")
ddt<- read.csv("../data/indices/ddt_wide.csv")
hch<- read.csv("../data/indices/hch_wide.csv")
metal<- read.csv("../data/indices/metal_wide.csv")
pbde<- read.csv("../data/indices/pbde_wide.csv")
pcb<- read.csv("../data/indices/pcb_wide.csv")
pesticide<- read.csv("../data/indices/pesticide_wide.csv")
...
#df1<- read.csv("/Users/cmantegna/Documents/Github/WDFWmussels/data/indices/avg_site_level.csv")

biomarkers<- c("p450", "sod")
morphometrics<- c("shell", "weight_initial", "weight_change", "weight_final", "length", "height", "width")
