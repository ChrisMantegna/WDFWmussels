...
# Select and scale biomarkers and morphometrics - including condition indices so I don't have to scale them separately later
#ibr_vars <- df %>%
...
morphometrics<- c("weight_initial_g", "weight_change_g", "weight_final_g",
                   "shell", "length_mm", "height_mm", "width_mm", "ci1", "ci2", "ci3")
...
ibr_df <- ibr_df %>%
 mutate(
    ...
    ibr3_overall = rowMeans(cbind(ibr2_biomarkers, ibr2_morphometrics), na.rm = TRUE)
  )
