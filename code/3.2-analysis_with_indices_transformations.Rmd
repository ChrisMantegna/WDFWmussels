...
#ibr_morph
#morph_anova_site <- aov(ibr_morph ~ site_name, data = sample_data) # p-value= 
...
# ibr_bio
#kruskal.test(tc_ibr_bio ~ site_number, data = sample_data) # p-value = 
kruskal.test(ibr_bio ~ reporting_area, data = site_data) # p-value = 0.6185

# ibr_combined
#kruskal.test(p450 ~ site_number, data = sample_data) # p-value = 
