...
view(tukey_table_with_cld)
getwd()
write.csv(tukey_table_with_cld, "../output/anova_kw_results/tukey_ci3_site_10032025.csv", row.names = FALSE) 
...
view(tukey_table_with_cld)
#write.csv(tukey_table_with_cld, "../output/anova_kw_results/tukey_morph_site_10022025.csv", row.names = FALSE) 
...
### length, width, height, weight_initial, weight_final.
```{r}
