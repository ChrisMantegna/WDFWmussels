...
metrics_vars <- df1_metals %>%
  select(p450, sod, shell, ci1, ci2, ci3,
         ibr1bio, ibr1morph, ibr1overall)

analyte_vars <- df_combined %>%
  select(starts_with("analyte"))  # adjust this selector if needed

# Spearman correlation
spearman_corr <- cor(metrics_vars, analyte_vars, method = "spearman", use = "pairwise.complete.obs")

# Kendall's tau
kendall_corr <- cor(metrics_vars, analyte_vars, method = "kendall", use = "pairwise.complete.obs")
