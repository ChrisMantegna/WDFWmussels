...
### commented out line indicate non- significant results
```{r}

#KW
#kruskal.test(p450 ~ site_name, data = df1) 
#kruskal.test(p450 ~ reporting_area, data = df1)
...
## contaminant indices, all samples
```{r}

#sod - something is wrong with the pah & metal indices p-values

#kruskal.test(sod ~ chlordane, data = sample_data) # p-value = 0.6495
kruskal.test(sod ~ ddt, data = sample_data) # p-value = 0.007339
#kruskal.test(sod ~ hch, data = sample_data) # p-value = 0.07169
kruskal.test(sod ~ heavy_metal, data = sample_data) # p-value = 0.001777
kruskal.test(sod ~ nutrient_metal, data = sample_data) # p-value = 0.001777
kruskal.test(sod ~ total_metal, data = sample_data) # p-value = 0.001777
kruskal.test(sod ~ pah_lmw, data = sample_data) # p-value = 0.001777
kruskal.test(sod ~ pah_hmw, data = sample_data) # p-value = 0.001777
kruskal.test(sod ~ pah_add, data = sample_data) # p-value = 0.001944
kruskal.test(sod ~ total_pah, data = sample_data) # p-value = 0.001777
kruskal.test(sod ~ pbde, data = sample_data) # p-value = 0.03638
kruskal.test(sod ~ pcb, data = sample_data) # p-value = 0.001777
kruskal.test(sod ~ pesticide, data = sample_data) # p-value = 0.02234

#shell
kruskal.test(shell ~ chlordane, data = sample_data) # p-value = 0.002914
kruskal.test(shell ~ ddt, data = sample_data) # p-value = 7.127e-08
#kruskal.test(shell ~ hch, data = sample_data) # p-value = 0.08548
kruskal.test(shell ~ heavy_metal, data = sample_data) # p-value = 1.092e-08
kruskal.test(shell ~ nutrient_metal, data = sample_data) # p-value = 1.092e-08
kruskal.test(shell ~ total_metal, data = sample_data) # p-value = 1.092e-08
kruskal.test(shell ~ pah_lmw, data = sample_data) # p-value = 1.092e-08
kruskal.test(shell ~ pah_hmw, data = sample_data) # p-value = 1.092e-08
kruskal.test(shell ~ pah_add, data = sample_data) # p-value = 3.105e-08
kruskal.test(shell ~ total_pah, data = sample_data) # p-value = 1.092e-08
kruskal.test(shell ~ pbde, data = sample_data) # p-value = 0.0004765
kruskal.test(shell ~ pcb, data = sample_data) # p-value = 1.092e-08
kruskal.test(shell ~ pesticide, data = sample_data) # p-value = 0.000112

#ci1
#kruskal.test(ci1 ~ chlordane, data = sample_data) # p-value = 0.2269
kruskal.test(ci1 ~ ddt, data = sample_data) # p-value = 0.0001987
#kruskal.test(ci1 ~ hch, data = sample_data) # p-value = 0.6598
kruskal.test(ci1 ~ heavy_metal, data = sample_data) # p-value = 0.001056
kruskal.test(ci1 ~ nutrient_metal, data = sample_data) # p-value = 0.001056
kruskal.test(ci1 ~ total_metal, data = sample_data) # p-value = 0.001056
kruskal.test(ci1 ~ pah_lmw, data = sample_data) # p-value = 0.001056
kruskal.test(ci1 ~ pah_hmw, data = sample_data) # p-value = 0.001056
kruskal.test(ci1 ~ pah_add, data = sample_data) # p-value = 0.001006
kruskal.test(ci1 ~ total_pah, data = sample_data) # p-value = 0.001056
kruskal.test(ci1 ~ pbde, data = sample_data) # p-value = 0.006813
kruskal.test(ci1 ~ pcb, data = sample_data) # p-value = 0.001056
#kruskal.test(ci1 ~ pesticide, data = sample_data) # p-value = 0.187

#ci2
kruskal.test(ci2 ~ chlordane, data = sample_data) # p-value = 0.002873
kruskal.test(ci2 ~ ddt, data = sample_data) # p-value = 1.076e-07
kruskal.test(ci2 ~ hch, data = sample_data) # p-value = 0.04207
kruskal.test(ci2 ~ heavy_metal, data = sample_data) # p-value = 2.191e-08
kruskal.test(ci2 ~ nutrient_metal, data = sample_data) # p-value = 2.191e-08
kruskal.test(ci2 ~ total_metal, data = sample_data) # p-value = 2.191e-08
kruskal.test(ci2 ~ pah_lmw, data = sample_data) # p-value = 2.191e-08
kruskal.test(ci2 ~ pah_hmw, data = sample_data) # p-value = 2.191e-08
kruskal.test(ci2 ~ pah_add, data = sample_data) # p-value = 1.643e-08
kruskal.test(ci2 ~ total_pah, data = sample_data) # p-value = 2.191e-08
kruskal.test(ci2 ~ pbde, data = sample_data) # p-value = 0.0003424
kruskal.test(ci2 ~ pcb, data = sample_data) # p-value = 2.191e-08
kruskal.test(ci2 ~ pesticide, data = sample_data) # p-value = 0.0007729

#ci3
#kruskal.test(ci3 ~ chlordane, data = sample_data) # p-value = 0.08169
kruskal.test(ci3 ~ ddt, data = sample_data) # p-value = 0.0004961
kruskal.test(ci3 ~ hch, data = sample_data) # p-value = 0.006942
kruskal.test(ci3 ~ heavy_metal, data = sample_data) # p-value = 0.0001364
kruskal.test(ci3 ~ nutrient_metal, data = sample_data) # p-value = 0.0001364
kruskal.test(ci3 ~ total_metal, data = sample_data) # p-value = 0.0001364
kruskal.test(ci3 ~ pah_lmw, data = sample_data) # p-value = 0.0001364
kruskal.test(ci3 ~ pah_hmw, data = sample_data) # p-value = 0.0001364
kruskal.test(ci3 ~ pah_add, data = sample_data) # p-value =9.769e-05
kruskal.test(ci3 ~ total_pah, data = sample_data) # p-value = 0.0001364
kruskal.test(ci3 ~ pbde, data = sample_data) # p-value = 0.003256
kruskal.test(ci3 ~ pcb, data = sample_data) # p-value = 0.0001364
kruskal.test(ci3 ~ pesticide, data = sample_data) # p-value = 0.01585

#ibr bio
#kruskal.test(ibr_bio ~ chlordane, data = sample_data) # p-value = 0.3371
kruskal.test(ibr_bio ~ ddt, data = sample_data) # p-value = 2.556e-05
#kruskal.test(ibr_bio ~ hch, data = sample_data) # p-value = 0.4202
kruskal.test(ibr_bio ~ heavy_metal, data = sample_data) # p-value = 1.652e-05
kruskal.test(ibr_bio ~ nutrient_metal, data = sample_data) # p-value = 1.652e-05
kruskal.test(ibr_bio ~ total_metal, data = sample_data) # p-value = 1.652e-05
kruskal.test(ibr_bio ~ pah_lmw, data = sample_data) # p-value = 1.652e-05
kruskal.test(ibr_bio ~ pah_hmw, data = sample_data) # p-value = 1.652e-05
kruskal.test(ibr_bio ~ pah_add, data = sample_data) # p-value = 3.369e-05
kruskal.test(ibr_bio ~ total_pah, data = sample_data) # p-value = 1.652e-05
kruskal.test(ibr_bio ~ pbde, data = sample_data) # p-value = 0.0124
kruskal.test(ibr_bio ~ pcb, data = sample_data) # p-value = 1.652e-05
kruskal.test(ibr_bio ~ pesticide, data = sample_data) # p-value = 0.04495

#ibr morph
kruskal.test(ibr_morph ~ chlordane, data = sample_data) # p-value = 0.02603
kruskal.test(ibr_morph ~ ddt, data = sample_data) # p-value = 4.255e-05
#kruskal.test(ibr_morph ~ hch, data = sample_data) # p-value = 0.0759
kruskal.test(ibr_morph ~ heavy_metal, data = sample_data) # p-value = 8.555e-05
kruskal.test(ibr_morph ~ nutrient_metal, data = sample_data) # p-value = 8.555e-05
kruskal.test(ibr_morph ~ total_metal, data = sample_data) # p-value = 8.555e-05
kruskal.test(ibr_morph ~ pah_lmw, data = sample_data) # p-value = 8.555e-05
kruskal.test(ibr_morph ~ pah_hmw, data = sample_data) # p-value = 8.555e-05
kruskal.test(ibr_morph ~ pah_add, data = sample_data) # p-value = 5.734e-05
kruskal.test(ibr_morph ~ total_pah, data = sample_data) # p-value = 8.555e-05
kruskal.test(ibr_morph ~ pbde, data = sample_data) # p-value = 0.002295
kruskal.test(ibr_morph ~ pcb, data = sample_data) # p-value = 8.555e-05
kruskal.test(ibr_morph ~ pesticide, data = sample_data) # p-value = 0.04029

#ibr combined
kruskal.test(ibr_combined ~ chlordane, data = sample_data) # p-value = 0.04963
kruskal.test(ibr_combined ~ ddt, data = sample_data) # p-value = 7.95e-05
#kruskal.test(ibr_combined ~ hch, data = sample_data) # p-value = 0.07206
kruskal.test(ibr_combined ~ heavy_metal, data = sample_data) # p-value = 0.0002026
kruskal.test(ibr_combined ~ nutrient_metal, data = sample_data) # p-value = 0.0002026
kruskal.test(ibr_combined ~ total_metal, data = sample_data) # p-value = 0.0002026
kruskal.test(ibr_combined ~ pah_lmw, data = sample_data) # p-value = 0.0002026
kruskal.test(ibr_combined ~ pah_hmw, data = sample_data) # p-value = 0.0002026
kruskal.test(ibr_combined ~ pah_add, data = sample_data) # p-value = 0.0002119
kruskal.test(ibr_combined ~ total_pah, data = sample_data) # p-value = 0.0002026
kruskal.test(ibr_combined ~ pbde, data = sample_data) # p-value = 0.001188
kruskal.test(ibr_combined ~ pcb, data = sample_data) # p-value = 0.0002026
#kruskal.test(ibr_combined ~ pesticide, data = sample_data) # p-value = 0.0845
...
#use this base for the contaminant indices
...
print(dunn_table) # view
#write.csv(dunn_table, "/Users/cmantegna/Documents/Github/WDFWmussels/output/MAYci1site.csv", row.names = FALSE) # write it out
...
#ci3 - reporting area is significant (2)
...
write.csv(dunn_table_with_cld, "/Users/cmantegna/Documents/Github/WDFWmussels/output/MAYci3ra.csv", row.names = FALSE) # write it out
