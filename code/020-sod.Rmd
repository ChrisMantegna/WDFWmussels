...
# no correlation
correlation_result <- cor.test(asdata$sod, asdata$PAHgroup, method = "pearson")
print(correlation_result)

# correlation= 0.1308783 with a p-value= 0.02096 indicates a weak positive correlation.
correlation_result <- cor.test(asdata$sod, asdata$PAHgroup2, method = "pearson")
print(correlation_result)
...
# Correlation test - sumPAH, lmwPAH, hmwPAH and PAH16
```{r}
