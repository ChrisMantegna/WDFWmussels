...
kruskal.test(sod ~ PAHgroup5, data = data)
kruskal.test(sod ~ PAHgroup6, data = data)
kruskal.test(sod ~ PAHgroup7, data = data)
...
### Group 7 - significance confirmed between 1-3, 1-4, 1-5, 1-6
...
mc_group4<- as.data.frame(kruskalmc(sod ~ PAHgroup4, data = data, method = "bonferroni")) 
mc_group7<- as.data.frame(kruskalmc(sod ~ PAHgroup7, data = data, method = "bonferroni")) 
mc_group8<- as.data.frame(kruskalmc(sod ~ PAHgroup8, data = data, method = "bonferroni")) 
