...
both<- read.csv("/Users/cmantegna/Documents/WDFWmussels/data/both_biomarkers_only.csv")
avg_both<- read.csv("/Users/cmantegna/Documents/WDFWmussels/data/avg_both_biomarkers.csv")
...
kruskal.test(sod ~ p450, data = both)
kruskal.test(p450 ~ sod, data = both)
...
correlation_result <- cor.test(avg_both$avg_p450, avg_both$avg_sod, method = "spearman")
