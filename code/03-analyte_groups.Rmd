...
write.csv(avg_sod_with_all_groups, "avg_sod_with_all_groups.csv", row.names = FALSE)
...
#write.csv(avg_cf_with_all_groups, "avg_cf_with_all_groups.csv", row.names = FALSE)
...
#write.csv(avg_at_with_all_groups, "avg_at_with_all_groups.csv", row.names = FALSE)
