...
colnames(man_df)[colnames(man_df) == "Broad Spit (Fisherman's Point)" ] <- "Broad Spit"
colnames(man_df)[colnames(man_df) == "Penrose Point State Park" ] <- "Pennrose Point State Park"
colnames(man_df)[colnames(man_df) == "Maristone Island Bridge" ] <- "Maristone Island"
colnames(man_df)[colnames(man_df) == "Suquamish, Stormwater Outfall" ] <- "Suquamish Stormwater Outfall"
...
#write.csv(allr, "alldata.csv", row.names = FALSE)
```
