...
write.csv(pah_lmw, "/Users/cmantegna/Documents/Github/WDFWmussels/data/index_df/pah_lmw_interim.csv", row.names = FALSE)
...
# Save the cleaned wide-format table
#write.csv(pah_lmw_wide, "/Users/cmantegna/Documents/Github/WDFWmussels/data/indices/pah_lmw_wide.csv", row.names = FALSE)
...
# define variables
pah_lmw_analytes <- names(pah_lmw_df)[4:14]
...
# Save the cleaned wide-format table
#write.csv(pah_hmw_wide, "/Users/cmantegna/Documents/Github/WDFWmussels/data/indices/pah_hmw_wide.csv", row.names = FALSE)
...
# define variables
pah_hmw_analytes <- names(pah_hmw_df)[4:14]
...
pah_add<- read.csv("../data/index_df/test_pah_add.csv")
# fixing site names, fixing column names, removing white space in the name changes, adjusting undetected values to zero, pivoting for index creation
...
# Save the cleaned wide-format table
write.csv(pah_add_wide, "/Users/cmantegna/Documents/Github/WDFWmussels/data/indices/pah_add_wide.csv", row.names = FALSE)
...
# define variables
pah_add_analytes <- names(pah_add_df)[4:14]
...
write.csv(pah_add_index, "/Users/cmantegna/Documents/Github/WDFWmussels/data/index_df/pah_add_index.csv", row.names = FALSE)
