...
# consider making a list of what was removed from this step (looks like we went from 299 to 288)
...
# table of sites included in each group
site_table <- data %>%
