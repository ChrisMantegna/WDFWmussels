...
analyte_names <- colnames(avg_data)[9:15] 
...
for (analyte in analyte_names) {
  p <- ggplot(avg_data, aes_string(x = analyte, y = "avg_sod")) +
    ...
    labs(
      title = paste(analyte, "vs SOD Activity"),
  ...
  # Save the plot
  ggsave(filename = paste0("analyte_plots/", analyte, "_v_SOD.png"), plot = p, width = 6, height = 4)
}
