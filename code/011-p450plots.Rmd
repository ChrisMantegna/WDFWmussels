...
# Plot
sicb_p450<- ggplot(data, aes(x = site_name, y = p450, fill = as.factor(reporting_area))) +
  geom_boxplot() +
  labs(
    x = "Sites", 
...
# Save 
ggsave(filename = "/Users/cmantegna/Documents/GitHub/WDFWmussels/output/sicb_p450.png", plot = sicb_p450, width = 12, height = 10, dpi = 300)
